...
public class MainActivity extends AppCompatActivity {
    ...
    private com.barafael.dodecaControl.MainActivityViewModel viewModel;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Setup our ViewModel
        viewModel = new ViewModelProvider(this).get(com.barafael.dodecaControl.MainActivityViewModel.class);
    ...
    public void openCommunicationsActivity(String deviceName, String macAddress) {
        Intent intent = new Intent(this, com.barafael.dodecaControl.CommunicateActivity.class);
